"""
Core DataUpdateCoordinator implementation for lixil_shutter.
...
class LixilShutterDataUpdateCoordinator(DataUpdateCoordinator):
    """
    ...
    config_entry: LixilShutterConfigEntry
    ...
    async def _async_update_data(self) -> Any:
        ...
        except LixilShutterApiClientAuthenticationError as exception:
