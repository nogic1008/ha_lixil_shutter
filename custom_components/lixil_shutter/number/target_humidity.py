"""Target humidity number for lixil_shutter."""

from __future__ import annotations

from typing import TYPE_CHECKING

from custom_components.lixil_shutter.api import LixilShutterApiClientError
from custom_components.lixil_shutter.const import LOGGER
from custom_components.lixil_shutter.entity import LixilShutterEntity
from homeassistant.components.number import NumberDeviceClass, NumberEntity, NumberEntityDescription, NumberMode
from homeassistant.const import PERCENTAGE
from homeassistant.exceptions import HomeAssistantError

if TYPE_CHECKING:
    from custom_components.lixil_shutter.coordinator import LixilShutterDataUpdateCoordinator
...
class LixilShutterHumidityNumber(NumberEntity, LixilShutterEntity):
    ...
    async def async_set_native_value(self, value: float) -> None:
        ...
        except LixilShutterApiClientError as exception:
            LOGGER.exception("Failed to set target humidity")
            raise HomeAssistantError(
                translation_domain="lixil_shutter",
