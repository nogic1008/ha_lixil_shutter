"""Device info utilities for lixil_shutter."""
...
def create_device_info(
    ...
    return DeviceInfo(
        ...
        name=name or "Lixil Bluetooth Shutter",
        manufacturer=manufacturer or "Lixil Bluetooth Shutter",
...
def get_device_identifiers(config_entry: ConfigEntry) -> set[tuple[str, str]]:
    ...
    Example:
        ...
        >>> # Returns: {('lixil_shutter', 'entry_id_value')}
    """
