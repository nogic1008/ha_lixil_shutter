"""
Base entity class for lixil_shutter.
...
from custom_components.lixil_shutter.const import ATTRIBUTION
...
class LixilShutterEntity(CoordinatorEntity[LixilShutterDataUpdateCoordinator]):
    """
    Base entity class for lixil_shutter.
