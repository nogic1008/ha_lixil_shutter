...
- **Repository:** nogic1008/ha_lixil_shutter

**Key directories:**

- `custom_components/lixil_shutter/` - Main integration code
...
- Integration logs: `custom_components.lixil_shutter: debug` in `config/configuration.yaml`
...
- Use the domain `lixil_shutter` for all DOMAIN references
- Prefix all integration-specific classes with `LixilShutter`
- Use "Lixil Bluetooth Shutter" as the display title
