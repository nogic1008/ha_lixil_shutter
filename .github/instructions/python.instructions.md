...
- Files: `snake_case.py`
- Classes: `PascalCase` prefixed with `LixilShutter`
...
- Inherit from both platform entity and `LixilShutterEntity` (order matters)
...
from custom_components.lixil_shutter.sensor import async_setup_entry
...
**Config entry data:** `entry_data: LixilShutterData = hass.data[DOMAIN][entry.entry_id]`
