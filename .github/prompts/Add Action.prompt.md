...
**File:** `custom_components/lixil_shutter/services.yaml`
...
Create `custom_components/lixil_shutter/service_actions/[action_name].py`:

```python
"""[Action name] service action for Lixil Bluetooth Shutter."""
...
**File:** `custom_components/lixil_shutter/__init__.py`
...
**File:** `custom_components/lixil_shutter/const.py`
...
3. Find service action: `lixil_shutter.[action_name]`
...
- **Service actions directory:** `custom_components/lixil_shutter/service_actions/` (preferred) or `actions/`
- **Service actions definition:** `custom_components/lixil_shutter/services.yaml` (legacy filename)
- **Icons:** `custom_components/lixil_shutter/icons.json` under `services` key (legacy)
- **Translations:** `custom_components/lixil_shutter/translations/*.json` under `services` key (legacy)
