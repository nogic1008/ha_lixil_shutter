...
- Inherit from `LixilShutterEntity` and platform base class
...
- Entity: `custom_components/lixil_shutter/[platform]/[entity_name].py`
- Platform: `custom_components/lixil_shutter/[platform]/__init__.py`
