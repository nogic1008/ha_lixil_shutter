...
- Create new sensor file in `custom_components/lixil_shutter/sensor/`
- Inherit from `LixilShutterEntity` and `SensorEntity`
...
```python
"""[Sensor description] for Lixil Bluetooth Shutter."""
...
class LixilShutter[SensorName]Sensor(
    LixilShutterEntity,
    SensorEntity,
):
...
- Entity: `custom_components/lixil_shutter/sensor/[sensor_name].py`
- Platform: `custom_components/lixil_shutter/sensor/__init__.py`
- Translations: `custom_components/lixil_shutter/translations/*.json`
