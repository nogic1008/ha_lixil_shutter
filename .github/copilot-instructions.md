...
- **Main code:** `custom_components/lixil_shutter/`
...
- `entity/` — Base entity class (`LixilShutterEntity`)
...
- Entity MRO: `(PlatformEntity, LixilShutterEntity)` — order matters
...
- Debug level: `custom_components.lixil_shutter: debug` in `config/configuration.yaml`
